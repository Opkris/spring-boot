...
public class DefaultDataInitializerService {
    ...
    public void initialize(){
        ...
        Long categorySoftwareEngineering = attempt(() -> categoryService.createCategory("Software Engineering"));
        Long categoryHistory = attempt(() -> categoryService.createCategory("History"));

        Long sEnterPriseProgramming = attempt(() -> categoryService.createSubCategory(categorySoftwareEngineering, "Enterprise Programming"));
        Long sInfoSecurity = attempt(() -> categoryService.createSubCategory(categorySoftwareEngineering, "Information Security"));
        Long sJava = attempt(() -> categoryService.createSubCategory(categorySoftwareEngineering, "Java"));
        Long sAlgorithms = attempt(() -> categoryService.createSubCategory(categorySoftwareEngineering, "Algorithms and Data Structure"));

        Long sRomanEmpire = attempt(() -> categoryService.createSubCategory(categoryHistory, "Roman Empire"));

        createEnterpriseQuestions(sEnterPriseProgramming);
        createJavaQuestions(sJava);
        createSecurityQuestions(sInfoSecurity);
        createAlgorithmQuestions(sAlgorithms);
        createRomeEmpireQuestions(sRomanEmpire);
    }
