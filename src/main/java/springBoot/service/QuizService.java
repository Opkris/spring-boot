...
public class QuizService {
    ...
    public List<Quiz> getRandomQuizzes(int number, long categoryId){
        ...
        if(number > size){
            throw new IllegalArgumentException("Cannot choose " + number + " unique quizzes out of the " + size + " existing");
        }
    ...
    public long createQuiz(
        ...
        quiz.setFirstAnswer(fourthAnswer);
